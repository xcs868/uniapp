<template name="graceLoading">
	<view class="grace-loading grace-ellipsis" v-if="loadingType < 4">
		<text class="iconfont icon-meiyougengduo" v-if="loadingType == 2">
...
.grace-loading{display:flex; width:100%; justify-content:center; padding:16rpx 0; padding-bottom:36rpx; line-height:40rpx; color:#888;font-size: 20rpx!important;}
